...
export default function Contact() {
  const address = {
    icon: <Home sx={{ fontSize: "5em", color: styleColors.primary }} />,
    title: "Địa Chỉ",
    texts: ["Hải An - Hải Lăng - Quảng Trị"],
  };
  const email = {
    icon: <Email sx={{ fontSize: "5em", color: styleColors.primary }} />,
    title: "Email",
    texts: ["Gmail: shoesshop@gmail.com", "Outlook: shoesshop@outlook.com"],
  };
  const phone = {
    icon: <Phone sx={{ fontSize: "5em", color: styleColors.primary }} />,
    title: "Điện Thoại",
    texts: ["+8400000000", "+8400000000"],
  };
  return (
    <Box py={10} textAlign="center">
      <PrimaryHeading color={styleColors.primary}>Liên Hệ</PrimaryHeading>
